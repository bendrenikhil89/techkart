...
const {createProduct, updateProduct, removeProduct,fetchProduct, fetchAllProducts, fetchProductsByPageSize, postRating, searchFilters, fetchProductsByCategory} = require("../controllers/product-controller");
