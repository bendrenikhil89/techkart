...
const {createProduct, updateProduct, removeProduct,fetchProduct, fetchAllProducts, fetchProductsByPageSize, postRating, searchFilters, fetchProductsByCategory, productsCount} = require("../controllers/product-controller");
